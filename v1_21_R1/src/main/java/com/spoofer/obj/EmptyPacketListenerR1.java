...
public class EmptyPacketListenerR1 extends ServerGamePacketListenerImpl {
    public EmptyPacketListenerR1(MinecraftServer server, Connection connection, ServerPlayer player,
