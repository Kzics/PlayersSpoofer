...
public class EmptyPacketListenerR3 extends ServerGamePacketListenerImpl {
    public EmptyPacketListenerR3(MinecraftServer server, Connection connection, ServerPlayer player,
